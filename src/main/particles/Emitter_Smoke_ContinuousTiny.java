...
public class Emitter_Smoke_ContinuousTiny extends ParticleEmitter {
	 ...
	 */
	public Emitter_Smoke_ContinuousTiny() {
	}
	 ...
	 */
	public Emitter_Smoke_ContinuousTiny(int x, int y) {
		this.x = x;
		this.y = y;
	}
	 ...
	 */
	public Emitter_Smoke_ContinuousTiny(int x, int y, float size) {
		this.x = x;
		this.y = y;
		this.size = size;
	}
