...
public class Emitter_Smoke_PuffMed extends ParticleEmitter {
	 ...
	 */
	public Emitter_Smoke_PuffMed(int x, int y) {
		this.x = x;
		this.y = y;
	}
	 ...
	 */
	public Emitter_Smoke_PuffMed(int x, int y, float size) {
		this.x = x;
		this.y = y;
		this.size = size;
	}
